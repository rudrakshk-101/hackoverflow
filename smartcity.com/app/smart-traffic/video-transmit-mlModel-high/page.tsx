...
const Video = () => {
 ...
 useEffect(() => {
    ...
    setTimeout(() => {
      window.location.href = "http://127.0.0.1:5000/transmitMLHighSystem";
    }, 12000);
 }, []);

 return (
    <div>
      <iframe src="http://127.0.0.1:5000/video_feed/red.mp4" className="w-[91.2vw] flex scale-75 h-[92vh] overflow-hidden"></iframe>
